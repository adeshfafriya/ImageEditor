...
public class CropImageOptions implements Parcelable {
  ...
  public CropImageOptions() {
    ...
    borderLineThickness = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 4, dm);
    borderLineColor = Color.argb(170, 255, 255, 255);
    borderCornerThickness = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 4, dm);
    ...
    borderCornerColor = Color.parseColor("#fa4616");
    ...
    activityTitle = "";
    activityMenuIconColor = Color.parseColor("#fa4616");
