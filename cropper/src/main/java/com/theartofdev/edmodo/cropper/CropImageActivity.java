...
public class CropImageActivity extends AppCompatActivity
  ...
  private MenuItem flip, brightness;
  private Menu menu;
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    this.menu = menu;
//    flip = menu.findItem(R.id.crop_image_menu_flip);
//    flip.setVisible(false);

    brightness = menu.findItem(R.id.bright_image_menu_crop);
...
//      updateMenuItemIconColor(menu, R.id.crop_image_menu_flip, mOptions.activityMenuIconColor);
      ...
      updateMenuItemIconColor(menu, R.id.bright_image_menu_crop, mOptions.activityMenuIconColor);
...
//      return true;
//    }
    if (item.getItemId() ==  R.id.bright_image_menu_crop){
      if (!isEnhanced){
        isEnhanced = true;
        updateMenuItemIconColor(menu, R.id.bright_image_menu_crop, Color.parseColor("#616161"));
        mCropImageView.brightenUpImage(isEnhanced);
      }
      else {
        isEnhanced = false;
        updateMenuItemIconColor(menu, R.id.bright_image_menu_crop, mOptions.activityMenuIconColor);
        mCropImageView.setOriginalBitmap(isEnhanced);
      }
      return true;
    }
  ...
  @Override
  public void onSetImageUriComplete(CropImageView view, Uri uri, Exception error, int averageBrightness) {
